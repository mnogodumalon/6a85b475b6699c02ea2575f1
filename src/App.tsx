...
import KursverwaltungDetailPage from '@/pages/KursverwaltungDetailPage';
import KursanmeldungPage from '@/pages/KursanmeldungPage';
import KursanmeldungDetailPage from '@/pages/KursanmeldungDetailPage';
// <custom:imports>
const IntentKursanmeldungVerwaltenPage = lazy(() => import('@/pages/intents/KursanmeldungVerwaltenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="kursverwaltung" element={<KursverwaltungPage />} />
                <Route path="kursverwaltung/:id" element={<KursverwaltungDetailPage />} />
                <Route path="kursanmeldung" element={<KursanmeldungPage />} />
                <Route path="kursanmeldung/:id" element={<KursanmeldungDetailPage />} />
                <Route path="admin" element={<AdminPage />} />
                <Route path="verwaltung/oeffentliche-seiten" element={<PublicPagesAdmin />} />
                {/* <custom:routes> */}
                <Route path="intents/kursanmeldung-verwalten" element={<Suspense fallback={null}><IntentKursanmeldungVerwaltenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
