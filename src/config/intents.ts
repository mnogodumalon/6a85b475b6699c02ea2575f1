...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/kursanmeldung-verwalten', label: { de: 'Anmeldung erfassen', en: 'Register participant' }, icon: IconUserPlus, description: 'Teilnehmer intern einem Kurs zuweisen — in zwei Schritten' },
  // </custom:intents>
];
