...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Yoga Kursplan & Anmeldung",
    "apps": {
      "kursverwaltung": {
        "name": "Kursverwaltung",
        "app_id": "6a85b4625daa8d682242a596",
        "fields": {
          "kursname": "Kursname",
      ...
      "kursanmeldung": {
        "name": "Kursanmeldung",
        "app_id": "6a85b465a3b42067c6974807",
        "fields": {
          "vorname": "Vorname",
          "nachname": "Nachname",
  ...
  "en": {
    "appgroup": "Yoga Course Schedule & Registration",
    "apps": {
      "kursverwaltung": {
        ...
        "fields": {
          ...
          "aktuelle_belegung": "Current Enrollment"
        },
        "lookups": {
          "wochentag": {
            "montag": "Monday",
